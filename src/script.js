	...
	return (
		<div className="container" id="app-box">
			<div className="row justify-content-around p-5">
				<div className="col-7 buttonBox d-flex flex-column">
					<DrumButtons
				...
				<div className="col-4 controlBox">
					<OutputBox output={output} />
					<ToggleBar power={power} setPower={setPower} />
					<SliderBar
						setVolume={setVolume}
						power={power}
		...
		<>
			<div className="row my-3">
				<div className="col d-flex justify-content-around flex-column">
					<label for="volumeRange" class="volume">
						Adjust Volume
					</label>
					<input
						type="range"
			...
			<div className="row my-3">
				<div className="col d-flex justify-content-center">
					<svg viewBox="0 0 512 512" width="100" title="drum">
						<path
